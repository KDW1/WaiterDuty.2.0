...
async function weekInteraction(week = null) {
    ...
    if(week == null) {
        let weekToReturn = [roster.rosters]
        return weekToReturn
    } 
    weekToReturn.rosters = week;
